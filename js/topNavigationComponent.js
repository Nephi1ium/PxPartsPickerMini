        ...
        const hnav =
            `<nav class="allNav">
                <nav class="fullSizeNav">
                    ...
                    <a href="px-picker-ttsuction.html" class="nav-item" id="">PDF</a>
                    <a href="px-picker-ttsuction.html" class="nav-item" id="">Virtual Care</a>
                ...
                <nav id="mobileNav" class="mobileNav">
                    ...
                    <a href="px-picker-ttsuction.html" class="mobileNavigationBut" id="PDFBut">PDF</a>
                    <a href="px-picker-ttsuction.html" class="mobileNavigationBut" id="VCareBut">Virtual Care</a>
                </nav>
            </nav>`;
