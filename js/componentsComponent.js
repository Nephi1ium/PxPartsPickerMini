        ...
        data.forEach(component => {  
            ...
            compCard.innerHTML = compCard.innerHTML +
             `<div class="card list" id="${component.valAssign}">
                <div class="card-header">
                    <h4> ${component.name} </h4>
                    <a class="kneeClick btn btn-primary" onclick="pxCompFavoritesKS(${component.valAssign})" > Add To Favorites </a>
                    <div class="card-body">
                    <img class="card-image" src="${component.image}"></img>
                    <h5> Product Description </h5>
                    <div id="${component.weight}">${component.weight}</div>
            ...
            data.forEach(component => {  
                ...
                compCard.innerHTML = compCard.innerHTML +
                 `<div class="card list" id="${component.valAssign}">
                    <div class="card-header">
                        <h4> ${component.name} </h4>
                        <a class="kneeClick btn btn-primary" onclick="pxCompFavoritespxComp(${component.valAssign})" > Add To Favorites </a>
                        <div class="card-body">
                        <img class="card-image" src="${component.image}"></img>
                        <h5> Product Description </h5>
                        <div id="${component.weight}">${component.weight}</div>
